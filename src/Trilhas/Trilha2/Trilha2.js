        ...
        return (
            <main>
                ...
                <section id='inicio-trilha'>
                    ...
                    <div id='conteudo'>
                        <div id='box-texto'>
                            <p className='texto'>As esculturas podem ser figurativas: que são aquelas que representam a imagem de uma pessoa, animal, objeto, etc., e também tem as esculturas abstratas, que não representa objetos próprios da nossa realidade.</p>
